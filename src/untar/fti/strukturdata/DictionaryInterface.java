...
public interface DictionaryInterface<K, V> {
	 ...
	 *        key already exits in the dictionary, replaces the corresponding value.
	 *        
	 *  @param	key		an object search key of the new entry
	 *  @param	value	an object associated with the search key
	 *  @return either null if the new entry was added to the dictionary or the value that was
	 *          associated with key if that value was replaced
	 */
	...
	/** Task: Sees whether a specific entry is in the directory.
	 * 
	...
	/** Task: Creates an iterator that traverses all search keys in the dictionary.
	 * 
	...
	/** Task: Creates an iterator that traverses all values in the dictionary.
	 * 
